...
/***/ (function(module, exports) {
	...
	var Plates = function (_React$Component2) {
	  _inherits(Plates, _React$Component2);

	  function Plates() {
	    _classCallCheck(this, Plates);

	    return _possibleConstructorReturn(this, (Plates.__proto__ || Object.getPrototypeOf(Plates)).apply(this, arguments));
	  }

	  _createClass(Plates, [{
	    key: "renderPlate",
	    value: function renderPlate(plate) {
	      var plates = [];
	      for (var i = 0; i < plate.count / 2; i++) {
	        plates.push(React.createElement("span", { "data-weight": plate.weight }));
	      }
	      return plates;
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          "div",
	          { className: "plates-display" },
	          React.createElement(
	            "div",
	            { className: "plates-left" },
	            Array.from(this.props.plates).reverse().map(function (plate) {
	              return _this3.renderPlate(plate);
	            })
	          ),
	          React.createElement(
	            "div",
	            { className: "plates-right" },
	            this.props.plates.map(function (plate) {
	              return _this3.renderPlate(plate);
	            })
	          )
	        ),
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            null,
	            this.props.plates.map(function (plate) {
	              if (plate.count) return React.createElement(
	                "li",
	                null,
	                plate.count,
	                " \xD7 ",
	...
	var App = function (_React$Component3) {
	  ...
	  function App(props) {
	    ...
	    var bar = 45;
	    var value = 145 - bar;
	    var weights = [45, 25, 15, 10, 5, 2.5];
	    var plates = _this4.setPlates(value, weights.map(function (w) {
	      return { weight: w, count: 0, greater: w * 2 };
	    }));

	    _this4.state = { value: value, plates: plates };
	    return _this4;
	  }
	  ...
	  _createClass(App, [{
	    ...
	    value: function handleChange(event) {
	      ...
	      var plates = this.setPlates(value, this.state.plates);

	      this.setState({ value: value, plates: plates });
	    }
	  }, {
	    key: "setPlates",
	    value: function setPlates(weight, plates) {
	      weight = weight - 45;
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(Plates, { plates: this.state.plates })
	      );
	    }
	  }]);
